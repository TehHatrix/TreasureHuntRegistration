<?php 
    ...
    include_once("config.php");
    $errorMessage = validateMember($playerName, $playerPassword1, $playerEmail);
    
    if (empty($errorMessage)) {
        $playerCount = isMemberExists($playerName, $playerEmail);
        
        if ($playerCount == 0) {
            $insertId = insertMemberRecord($playerName, $playerEmail, $playerPassword1);
            if (! empty($insertId)) {
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="playerRegister.html">Register - As a Player</a>
